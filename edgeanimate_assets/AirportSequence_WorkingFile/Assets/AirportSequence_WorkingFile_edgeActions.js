...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_TouchPoint_smb4}","click",function(sym,e){sym.play("BP_ITPract");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_TouchPoint_smb4Copy}","click",function(sym,e){sym.play("BP_Mana");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_TouchPoint_smb4Copy2}","click",function(sym,e){sym.play("BP_Everyone");});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_TouchPoint_smb2}","click",function(sym,e){sym.play("BP_SkipCrossFade");});
//Edge binding end
