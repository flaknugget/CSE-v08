...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_touchpoints_smb4}","click",function(sym,e){bestPractPos="pract";sym.play("BP_ITPract");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_touchpoints_smb4Copy}","click",function(sym,e){bestPractPos="mana";sym.play("BP_Mana");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_touchpoints_smb4Copy2}","click",function(sym,e){bestPractPos="every";sym.play("BP_Everyone");});
//Edge binding end
